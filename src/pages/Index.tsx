  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-deep-blue/80 via-deep-blue/50 to-transparent" />
        </div>
        ...
        <div className="container px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto">
            <div className="text-center space-y-4 p-6 rounded-lg bg-card shadow-[var(--shadow-md)] hover:shadow-[var(--shadow-lg)] transition-all">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-desert-gold to-sunset-orange">
            ...
            <div className="text-center space-y-4 p-6 rounded-lg bg-card shadow-[var(--shadow-md)] hover:shadow-[var(--shadow-lg)] transition-all">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-oasis-teal to-deep-blue">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-desert-gold via-sunset-orange to-oasis-teal">
      ...
      {/* Footer */}
      <footer className="py-12 bg-deep-blue text-white">
        <div className="container px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-2xl font-bold bg-gradient-to-r from-desert-gold to-oasis-teal bg-clip-text text-transparent">
                Terhal
              </p>
              <p className="text-white/70 mt-2">Aligned with Vision 2030</p>
            </div>
            <div className="flex space-x-6">
              <a href="#" className="hover:text-desert-gold transition-colors">About</a>
              <a href="#" className="hover:text-desert-gold transition-colors">Support</a>
              <a href="#" className="hover:text-desert-gold transition-colors">Privacy</a>
              <a href="#" className="hover:text-desert-gold transition-colors">Terms</a>
            </div>
          </div>
          <div className="mt-8 pt-8 border-t border-white/10 text-center text-white/60">
            <p>© 2024 Terhal. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
